...
costs_perton_all_2030 <- costs_perton_all |> mutate(year = 2030, eur_t = eur_t*1.012*1.003*1.026*1.084*1.054*1.024*1.021*(1.02)^5)
costs_perton_all_2040 <- costs_perton_all |> mutate(year = 2040, eur_t = eur_t*1.012*1.003*1.026*1.084*1.054*1.024*1.021*(1.02)^15)
costs_perton_all_2050 <- costs_perton_all |> mutate(year = 2050, eur_t = eur_t*1.012*1.003*1.026*1.084*1.054*1.024*1.021*(1.02)^25)
